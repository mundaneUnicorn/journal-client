  ...
  render() {
    ...
    return (
      <View style={ styles.container }>
        ...
        <EntryList user={ this.state.user } token={ this.state.token } entries={ this.props.entries } rerender={ this.props.rerender } navigator={ this.props.navigator } updatePostID={ () => {} } userEntries={ true } />
      </View>
